...
STORIES = [
    ...
    },
    {
        "id": 5,
        "title_han":    "愚公移山",
        "title_pinyin": "Yú gōng yí shān",
        "title_en":     "The Old Man Who Moved Mountains",
        "youtube_id":   "sYS1cfNKOeg",
        "youtube_label":"兔小贝 · animated story",
        "idiom_audio":  "audio/idioms/yu_gong_yi_shan.mp3",
        "body": [
            {"han": "相传古时候，有一位名叫愚公的老人家，年纪快九十岁了，和家人一起住在北山。",
             "pinyin": "Xiāng chuán gǔ shí hòu yǒu yī wèi míng jiào yú gōng de lǎo rén jiā nián jì kuài jiǔ shí suì le hé jiā rén yì qǐ zhù zài běi shān",
             "en": "Long ago there was an old man called Yu Gong, nearly ninety years old, who lived with his family at the foot of the northern mountains."},
            {"han": "他的家门口有两座大山，一座叫太行山，一座叫王屋山。",
             "pinyin": "Tā de jiā mén kǒu yǒu liǎng zuò dà shān yī zuò jiào tài háng shān yī zuò jiào wáng wū shān",
             "en": "Two great mountains stood in front of his home — Taihang and Wangwu."},
            {"han": "愚公一家需要绕过这两座大山才能到南方，出门非常不方便。",
             "pinyin": "Yú gōng yī jiā xū yào rào guò zhè liǎng zuò dà shān cái néng dào nán fāng chū mén fēi cháng bù fāng biàn",
             "en": "The family had to walk around both mountains to reach the south, which made travel very difficult."},
            {"han": "有一天，愚公把全家人叫来，对他们说：\"我准备和你们一起，用我全部的精力，来搬掉面前的太行山和王屋山，修出一条通向南方的大道，你们说好吗？\"",
             "pinyin": "Yǒu yī tiān yú gōng bǎ quán jiā rén jiào lái duì tā men shuō wǒ zhǔn bèi hé nǐ men yì qǐ yòng wǒ quán bù de jīng lì lái bān diào miàn qián de tài háng shān hé wáng wū shān xiū chū yī tiáo tōng xiàng nán fāng de dà dào nǐ men shuō hǎo ma",
             "en": "One day, Yu Gong gathered the family: \"I plan to use all my strength alongside you to remove these two mountains and build a great road south. What do you say?\""},
            {"han": "家里人都很赞成，但愚公的老伴想了想，问道：\"我们大家的力量加起来，还不能够搬一座小山，又怎么有力量把太行山和王屋山这两座大山搬掉呢？\"",
             "pinyin": "Jiā lǐ rén dōu hěn zàn chéng dàn yú gōng de lǎo bàn xiǎng le xiǎng wèn dào wǒ men dà jiā de lì liàng jiā qǐ lái hái bù néng gòu bān yī zuò xiǎo shān yòu zěn me yǒu lì liàng bǎ tài háng shān hé wáng wū shān zhè liǎng zuò dà shān bān diào ne",
             "en": "Everyone agreed, but his wife paused: \"All our strength combined couldn't move a small hill — how could we ever move two enormous mountains?\""},
            {"han": "\"况且，那些挖出来的泥土和石块要放到哪里去？\"",
             "pinyin": "Kuàng qiě nà xiē wā chū lái de ní tǔ hé shí kuài yào fàng dào nǎ lǐ qù",
             "en": "\"And where would all the dirt and stones we dig up go?\""},
            {"han": "一家人商量下来，准备第二天就开始动工，并把挖出来的泥土和石块扔到东方的海边和北方最远的地方。",
             "pinyin": "Yī jiā rén shāng liáng xià lái zhǔn bèi dì èr tiān jiù kāi shǐ dòng gōng bìng bǎ wā chū lái de ní tǔ hé shí kuài rēng dào dōng fāng de hǎi biān hé běi fāng zuì yuǎn de dì fāng",
             "en": "After discussing, they decided to start the next day, dumping the dirt and stones at the eastern sea and the farthest northern lands."},
            {"han": "第二天一大早，愚公就带着儿孙们开始挖山了。",
             "pinyin": "Dì èr tiān yī dà zǎo yú gōng jiù dài zhe ér sūn men kāi shǐ wā shān le",
             "en": "At dawn the next day, Yu Gong and his sons and grandsons began to dig."},
            {"han": "虽然一家人每天挖不了多少，但他们还是坚持挖，直到季节更替时才回家一次。",
             "pinyin": "Suī rán yī jiā rén měi tiān wā bù liǎo duō shǎo dàn tā men hái shì jiān chí wā zhí dào jì jié gēng tì shí cái huí jiā yī cì",
             "en": "They could only move a little each day, but they kept going — only returning home when the seasons changed."},
            {"han": "一位名叫智叟的老人知道这件事后，特地来劝说他。",
             "pinyin": "Yī wèi míng jiào zhì sǒu de lǎo rén zhī dào zhè jiàn shì hòu tè dì lái quàn shuō tā",
             "en": "An old man called Zhi Sou (\"the Wise Old Man\") heard about this and came to talk him out of it."},
            {"han": "\"愚公，你这样做实在不聪明。凭你这有限的精力，又怎么能把这两座山挖平呢？\"",
             "pinyin": "Yú gōng nǐ zhè yàng zuò shí zài bù cōng míng píng nǐ zhè yǒu xiàn de jīng lì yòu zěn me néng bǎ zhè liǎng zuò shān wā píng ne",
             "en": "\"Yu Gong, this is foolish. With your limited strength, how can you possibly level two mountains?\""},
            {"han": "愚公回答说：\"你这个人太顽固了，简直没办法开导你。即使我死了，还有我的儿子在这里，将来我的儿子死了，还有我的孙子。\"",
             "pinyin": "Yú gōng huí dá shuō nǐ zhè ge rén tài wán gù le jiǎn zhí méi bàn fǎ kāi dǎo nǐ jí shǐ wǒ sǐ le hái yǒu wǒ de ér zi zài zhè lǐ jiāng lái wǒ de ér zi sǐ le hái yǒu wǒ de sūn zi",
             "en": "Yu Gong replied: \"You are far too stubborn — there's no reasoning with you. Even when I die, my sons remain. When they die, my grandsons.\""},
            {"han": "\"孙子又生孩子，孩子又生儿子，子子孙孙世代延续没有穷尽，但是山却不会再增高。为什么挖不平呢？\"",
             "pinyin": "Sūn zi yòu shēng hái zi hái zi yòu shēng ér zi zǐ zǐ sūn sūn shì dài yán xù méi yǒu qióng jìn dàn shì shān què bú huì zài zēng gāo wèi shén me wā bù píng ne",
             "en": "\"Grandsons have sons, sons have grandsons — generation after generation, endless. But the mountains won't grow taller. Why couldn't we level them?\""},
            {"han": "智叟听了无话可说。",
             "pinyin": "Zhì sǒu tīng liǎo wú huà kě shuō",
             "en": "Zhi Sou had nothing to say."},
            {"han": "当时山神见愚公他们不停地挖山，就向帝君报告了这件事。帝君被愚公的精神感动，派了两个大力神下凡，把两座大山背走。",
             "pinyin": "Dāng shí shān shén jiàn yú gōng tā men bù tíng dì wā shān jiù xiàng dì jūn bào gào le zhè jiàn shì dì jūn bèi yú gōng de jīng shén gǎn dòng pài le liǎng gè dà lì shén xià fán bǎ liǎng zuò dà shān bèi zǒu",
             "en": "The mountain spirits, seeing them dig without rest, reported it to the Emperor of Heaven. Moved by Yu Gong's spirit, the Emperor sent two mighty gods to carry the mountains away."},
            {"han": "从此这里不再有高山阻隔，道路畅通了。",
             "pinyin": "Cóng cǐ zhè lǐ bù zài yǒu gāo shān zǔ gé dào lù chàng tōng le",
             "en": "From then on, no mountains stood in the way, and the road south was clear."},
        ],
        "moral": {"han": "比喻坚持不懈地改造自然或克服巨大困难。",
                  "pinyin": "Bǐ yù jiān chí bù xiè dì gǎi zào zì rán huò kè fú jù dà kùn nán",
                  "en": "A metaphor for unwavering perseverance against great obstacles."},
    },
    {
        "id": 6,
        "title_han":    "狐假虎威",
        "title_pinyin": "Hú jiǎ hǔ wēi",
        "title_en":     "The Fox Borrows the Tiger's Might",
        "youtube_id":   "aGk_1sFQKus",
        "youtube_label":"熊猫博士和托托 · animated story",
        "idiom_audio":  "audio/idioms/hu_jia_hu_wei.mp3",
        "body": [
            {"han": "从前，在一座山上，有只大老虎，它长着巨大的爪子，锋利的牙齿，吼一声，山上的树木都跟着刷刷响，威风极了。",
             "pinyin": "Cóng qián zài yī zuò shān shàng yǒu zhǐ dà lǎo hǔ tā zhǎng zhe jù dà de zhuǎ zi fēng lì de yá chǐ hǒu yī shēng shān shàng de shù mù dōu gēn zhe shuā shuā xiǎng wēi fēng jí le",
             "en": "Long ago on a mountain, there was a great tiger — huge claws, sharp teeth. When he roared, the trees all rustled. He was tremendously fierce."},
            {"han": "这一天，老虎在山中寻找食物，捉到了一只狐狸。",
             "pinyin": "Zhè yī tiān lǎo hǔ zài shān zhōng xún zhǎo shí wù zhuō dào le yī zhī hú lí",
             "en": "One day, while hunting in the mountains, the tiger caught a fox."},
            {"han": "狐狸突然灵光一现，想到了办法：\"哎，你这无礼的老虎，竟然敢吃我？你可知道我是谁？\"",
             "pinyin": "Hú lí tū rán líng guāng yī xiàn xiǎng dào le bàn fǎ āi nǐ zhè wú lǐ de lǎo hǔ jìng rán gǎn chī wǒ nǐ kě zhī dào wǒ shì shuí",
             "en": "The fox had a sudden flash of inspiration. \"Hey, you rude tiger — how dare you eat me? Do you know who I am?\""},
            {"han": "老虎吃了一惊，松开了压着狐狸的爪子，上下打量着狐狸：\"你不就是一只狐狸吗？\"",
             "pinyin": "Lǎo hǔ chī le yī jīng sōng kāi le yā zhe hú lí de zhuǎ zi shàng xià dǎ liàng zhe hú lí nǐ bù jiù shì yī zhī hú lí ma",
             "en": "The tiger was startled, released the fox, and looked it up and down. \"Aren't you just a fox?\""},
            {"han": "狐狸趁机站在老虎面前双手插腰，挺着胸脯说：\"哼，你这没见识的老虎，我可是天帝派来的使者，专门负责掌管百兽的。\"",
             "pinyin": "Hú lí chèn jī zhàn zài lǎo hǔ miàn qián shuāng shǒu chā yāo tǐng zhe xiōng pú shuō hēng nǐ zhè méi jiàn shí de lǎo hǔ wǒ kě shì tiān dì pài lái de shǐ zhě zhuān mén fù zé zhǎng guǎn bǎi shòu de",
             "en": "The fox seized the moment, stood up, hands on hips, chest out: \"Hmph, you ignorant tiger! I'm the messenger from the Emperor of Heaven, in charge of all the beasts.\""},
            {"han": "\"你要是吃了我，就是违抗天帝的命令，天帝一定会重重惩罚你。\"",
             "pinyin": "Nǐ yào shì chī le wǒ jiù shì wéi kàng tiān dì de mìng lìng tiān dì yí dìng huì chóng chóng chéng fá nǐ",
             "en": "\"If you eat me, you defy the Emperor's command — and he will punish you severely.\""},
            {"han": "老虎觉得狐狸的话不可信，可是看到狐狸那副傲慢镇定的样子，又不像是在骗人。",
             "pinyin": "Lǎo hǔ jué de hú lí de huà bù kě xìn kě shì kàn dào hú lí nà fù ào màn zhèn dìng de yàng zi yòu bù xiàng shì zài piàn rén",
             "en": "The tiger doubted, but the fox's haughty calm didn't look like a lie."},
            {"han": "狐狸说：\"那你敢不敢跟我去森林里走一趟，看看百兽们见到我，是不是都害怕地逃走。\"",
             "pinyin": "Hú lí shuō nà nǐ gǎn bù gǎn gēn wǒ qù sēn lín lǐ zǒu yī tàng kàn kàn bǎi shòu men jiàn dào wǒ shì bú shì dōu hài pà dì táo zǒu",
             "en": "The fox said: \"Then dare you walk through the forest with me — see whether the beasts flee when they see me.\""},
            {"han": "老虎答应了。狐狸吹着口哨，大摇大摆地走在森林里，老虎半信半疑地跟在他身后。",
             "pinyin": "Lǎo hǔ dā yìng le hú lí chuī zhe kǒu shào dà yáo dà bǎi dì zǒu zài sēn lín lǐ lǎo hǔ bàn xìn bàn yí dì gēn zài tā shēn hòu",
             "en": "The tiger agreed. The fox strode ahead whistling, the tiger following half-believing."},
            {"han": "没走多久，他们就看到一群小兔子正在树下吃草。小兔子们回头看到狐狸身后的大老虎，吓得四散奔逃。",
             "pinyin": "Méi zǒu duō jiǔ tā men jiù kàn dào yī qún xiǎo tù zi zhèng zài shù xià chī cǎo xiǎo tù zi men huí tóu kàn dào hú lí shēn hòu de dà lǎo hǔ xià dé sì sàn bēn táo",
             "en": "Before long, they came upon a group of rabbits eating grass. The rabbits looked up, saw the tiger behind the fox, and scattered in terror."},
            {"han": "无论地上跑的野猪、梅花鹿，还是天上飞的乌鸦、黄鹂鸟，看到他们后都躲得远远的。",
             "pinyin": "Wú lùn dì shàng pǎo de yě zhū méi huā lù hái shì tiān shàng fēi de wū yā huáng lí niǎo kàn dào tā men hòu dōu duǒ dé yuǎn yuǎn de",
             "en": "Wild boars, sika deer, crows, orioles — every animal that saw them fled far away."},
            {"han": "狐狸偷偷一笑，得意地说：\"看到了吧，这些动物看到我吓得连魂都没了。你是百兽之王，我可是王中之王。\"",
             "pinyin": "Hú lí tōu tōu yī xiào dé yì dì shuō kàn dào le ba zhè xiē dòng wù kàn dào wǒ xià dé lián hún dōu méi le nǐ shì bǎi shòu zhī wáng wǒ kě shì wáng zhōng zhī wáng",
             "en": "The fox smiled secretly and said with pride: \"See? They're scared out of their wits at the sight of me. You're king of beasts — I'm king of kings.\""},
            {"han": "老虎不禁出了一身冷汗，忙俯下身来说：\"狐狸大人，您真是太厉害了，我以后再也不敢冒犯您了。\"",
             "pinyin": "Lǎo hǔ bù jīn chū le yī shēn lěng hàn máng fǔ xià shēn lái shuō hú lí dà rén nín zhēn shì tài lì hài le wǒ yǐ hòu zài yě bù gǎn mào fàn nín le",
             "en": "Cold sweat ran down the tiger's back. He bowed: \"Master Fox, you are truly mighty. I'll never offend you again.\""},
            {"han": "树上的猫头鹰目睹了这一切，对狐狸说：\"你狐假虎威，借着老虎的威风吓唬小动物们，真狡猾。仗势欺人是不对的。\"",
             "pinyin": "Shù shàng de māo tóu yīng mù dǔ le zhè yī qiè duì hú lí shuō nǐ hú jiǎ hǔ wēi jiè zhe lǎo hǔ de wēi fēng xià hǔ xiǎo dòng wù men zhēn jiǎo huá zhàng shì qī rén shì bú duì de",
             "en": "An owl above had watched it all, and said to the fox: \"You're 狐假虎威 — borrowing the tiger's might to scare the others. That's cunning. Bullying with borrowed power is wrong.\""},
        ],
        "moral": {"han": "借着别人的势力吓唬人或欺压别人。",
                  "pinyin": "Jiè zhe bié rén de shì lì xià hǔ rén huò qī yā bié rén",
                  "en": "Bullying others by leaning on someone else's power."},
    },
    {
        "id": 7,
        "title_han":    "刻舟求剑",
        "title_pinyin": "Kè zhōu qiú jiàn",
        "title_en":     "Carving the Boat to Find the Sword",
        "youtube_id":   "-f9eslaLIv0",
        "youtube_label":"三淼儿童 · 深刻的成语故事",
        "idiom_audio":  "audio/idioms/ke_zhou_qiu_jian.mp3",
        "body": [
            {"han": "一个楚国人坐船出去，船划到河中心的时候，他不小心把身上的剑掉到了水里。",
             "pinyin": "Yí gè chǔ guó rén zuò chuán chū qù chuán huà dào hé zhōng xīn de shí hòu tā bù xiǎo xīn bǎ shēn shàng de jiàn diào dào le shuǐ lǐ",
             "en": "A man from the state of Chu was traveling by boat. When the boat reached the middle of the river, he accidentally dropped his sword into the water."},
            {"han": "这个楚国人急忙在船边刻了个记号。旁边人问他：\"你不下去捞剑，在这里刻记号做什么？\"",
             "pinyin": "Zhè ge chǔ guó rén jí máng zài chuán biān kè le gè jì hào páng biān rén wèn tā nǐ bù xià qù lāo jiàn zài zhè lǐ kè jì hào zuò shén me",
             "en": "He quickly carved a mark on the side of the boat. Someone next to him asked: \"Why are you carving instead of jumping in to fetch it?\""},
            {"han": "他回答说：\"剑是从这里掉下去的，河中心的水太深了，等到岸边水浅的地方，我再从记号这里下去把剑给捞上来。\"",
             "pinyin": "Tā huí dá shuō jiàn shì cóng zhè lǐ diào xià qù de hé zhōng xīn de shuǐ tài shēn le děng dào àn biān shuǐ qiǎn de dì fāng wǒ zài cóng jì hào zhè lǐ xià qù bǎ jiàn gěi lāo shàng lái",
             "en": "He answered: \"The sword fell from this exact spot. Mid-river is too deep. When we reach the shallow shore, I'll dive in from this mark and bring it up.\""},
            {"han": "船到岸边停下来后，这个楚国人果然从他刻记号的地方跳到了水里去捞剑。",
             "pinyin": "Chuán dào àn biān tíng xià lái hòu zhè ge chǔ guó rén guǒ rán cóng tā kè jì hào de dì fāng tiào dào le shuǐ lǐ qù lāo jiàn",
             "en": "When the boat stopped at the shore, the man indeed jumped in from where he had carved the mark."},
            {"han": "可是船已经航行了很远，但是剑还在河中心。像这样怎么能找到剑呢？",
             "pinyin": "Kě shì chuán yǐ jīng háng xíng le hěn yuǎn dàn shì jiàn hái zài hé zhōng xīn xiàng zhè yàng zěn me néng zhǎo dào jiàn ne",
             "en": "But the boat had moved far, while the sword still lay in the middle of the river. How could he ever find it that way?"},
        ],
        "moral": {"han": "比喻做事死板，不知道随着情况的变化而变通。",
                  "pinyin": "Bǐ yù zuò shì sǐ bǎn bù zhī dào suí zhe qíng kuàng de biàn huà ér biàn tōng",
                  "en": "A metaphor for inflexibility — failing to adapt to changing circumstances."},
    },
    {
        "id": 8,
        "title_han":    "拔苗助长",
        "title_pinyin": "Bá miáo zhù zhǎng",
        "title_en":     "Pulling the Sprouts to Help Them Grow",
        "youtube_id":   "k8c8NFRaWn4",
        "youtube_label":"三淼儿童 · 深刻的成语故事",
        "idiom_audio":  "audio/idioms/ba_miao_zhu_zhang.mp3",
        "body": [
            {"han": "宋国有个农民种了一块地。他种下禾苗后，希望禾苗能够快点长大，快点结出果实。",
             "pinyin": "Sòng guó yǒu gè nóng mín zhǒng le yī kuài dì tā zhòng xià hé miáo hòu xī wàng hé miáo néng gòu kuài diǎn zhǎng dà kuài diǎn jié chū guǒ shí",
             "en": "In the state of Song, a farmer planted a field. After sowing the rice seedlings, he hoped they would grow tall and bear fruit quickly."},
            {"han": "因此他每天都到地里去看。但是禾苗长得很慢，他心里非常着急。",
             "pinyin": "Yīn cǐ tā měi tiān dōu dào dì lǐ qù kàn dàn shì hé miáo zhǎng dé hěn màn tā xīn lǐ fēi cháng zháo jí",
             "en": "So every day he went to check. But the seedlings grew slowly, and he grew very anxious."},
            {"han": "\"怎样才能让禾苗尽快长高呢？\"",
             "pinyin": "Zěn yàng cái néng ràng hé miáo jǐn kuài zhǎng gāo ne",
             "en": "\"How can I make the seedlings grow taller faster?\""},
            {"han": "一天他突然想到了一个主意：把禾苗一颗一颗地往高拔。",
             "pinyin": "Yī tiān tā tū rán xiǎng dào le yí gè zhǔ yì bǎ hé miáo yī kē yī kē dì wǎng gāo bá",
             "en": "One day he had a sudden idea: pull each seedling up by hand to make it taller."},
            {"han": "拔完后，看着禾苗明显比之前高出一大截，心里高兴极了。",
             "pinyin": "Bá wán hòu kàn zhe hé miáo míng xiǎn bǐ zhī qián gāo chū yī dà jié xīn lǐ gāo xìng jí le",
             "en": "When he finished, the seedlings stood visibly taller than before — and he was overjoyed."},
            {"han": "第二天他到地里一看，禾苗全都枯死了。",
             "pinyin": "Dì èr tiān tā dào dì lǐ yī kàn hé miáo quán dōu kū sǐ le",
             "en": "The next day he came to the field — and every seedling had withered and died."},
        ],
        "moral": {"han": "形容做事不遵循规律，急于求成，反而会坏事。",
                  "pinyin": "Xíng róng zuò shì bù zūn xún guī lǜ jí yú qiú chéng fǎn ér huì huài shì",
                  "en": "Forcing growth against natural pace ruins the outcome — haste makes waste."},
    },
]
